      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 mb-12">
          <div className="flex flex-col lg:flex-row items-center gap-8">
            ...
            <div className="lg:w-80">
              <img
                src="/professional-woman-in-red-jacket-sitting-at-desk.jpg"
                alt="مدیر عامل آبادیس پارسیان"
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed text-center max-w-4xl mx-auto">
            تیم آبادیس پارسیان متشکل از مشاوران تحصیلی مجرب، متخصصان امور دانشجویی و کارشناسان آشنا به فرهنگ و زبان روسی
            است. ما با بهره‌گیری از دانش روز و تجربه‌های عملی، بهترین راهنمایی‌ها را برای انتخاب رشته، دانشگاه و برنامه‌ریزی
            تحصیلی ارائه می‌دهیم. همچنین با داشتن شبکه‌ای گسترده از روابط با دانشگاه‌های معتبر روسیه، امکان اخذ پذیرش از
            بهترین مؤسسات آموزشی را فراهم می‌کنیم.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-white rounded-2xl shadow-md p-8 text-center">
            ...
            <p className="text-gray-600 leading-relaxed">
              تبدیل شدن به پیشروترین مرکز ارائه خدمات تحصیلی در منطقه و ایجاد پل ارتباطی میان نظام آموزشی ایران و روسیه
            </p>
          </div>
